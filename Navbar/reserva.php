...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/botonplanta.css">
...
<body>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="../Navbar/Acercade/Acercade.html">Acerca de</a></li>
    ...
    <div id="rev_slider_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="photography1"
        style="background-color:transparent;padding:0px;">
        <div id="rev_slider_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.0.7">
            <ul>
                <li data-index="rs" data-transition="">
                    <!-- MAIN IMAGE -->
                    <img src="../assets/images/navbar/reserva.jpg" alt="" data-bgposition="center center"
                    ...
                    <!-- LAYER NR. 2 -->
                    <div class="tp-caption Photography-Display tp-resizeme" id="fondo-3-layer-2"
                        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                        data-y="['middle','middle','middle','middle']" data-voffset="['-40','-40','-40','-20']"
                        data-fontsize="['40','40','40','30']" data-lineheight="['60','60','60','40']" data-width="none"
                        ...
                        style="z-index: 6; white-space: nowrap; font-family: Playfair Display;">
                        <form action="" method="POST">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="text-black nom" name="nombre" size="50px"
                                            maxlength="50" id="">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="dir" name="direccion" size="50px" maxlength="50"
                                            id="">
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <a href="reporte.php">
                            ...
                            if (isset($_POST['registrar'])) {
                                ...
                                if ($nom == "" or $pat == "" or $mat == "" or $dir == "" or $correo == "") {

                                    echo "<script> alert('Los campos son obligatorios')</script>";
                                } else {
                                    $insert = mysqli_query($mysqli, "INSERT INTO `clientes`(`nombre`, `apellidoP`, `apellidoM`, `direccion`, `telefono`, `distrito`, `correo`)
            VALUES ('$nom','$pat','$mat','$dir','$tel','$dis','$correo')");
                    ...
                    <!-- LAYER NR. 4 -->
                    <a href="../catalogo.php">
                        <div class="tp-caption rev-btn rev-bordered" id="fondo-3-layer-4"
                            ...
                            <button name="buttonplant">Catalogo de plantas
                                <div class="icon-1">
            ...
            <div class="row mb30">
                <div class="col-md-12">
                    <div class="footer-logo">
                        <img src="img/2.png" alt="" class="img-center img-responsive">
                    </div>
                </div>
            </div>
            <div class="row mb30">
                <div class="col-md-5 col-sm-5">
                    <div class="footer-contact text-right">
                        ...
                        <p>E-mail: <a href="" class="__cf_email__"
                                data-cfemail="533a3d353c132a3c2621373c3e323a3d7d303c3e">jordan137.jdcf@gmail.com</a></p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="footer-social">
                        <ul>
                            <li><a href="https://www.facebook.com/groups/chiphysiprogramacion/" target="_black"><i
                                        class="fa fa-facebook"></i></a></li>
                            <li><a href="https://www.youtube.com/channel/UC87BrnQy7Y6iipGvQ6sAJfQ" target="_black"><i
                                        class="fa fa-youtube"></i></a></li>
                            <li><a href="https://www.linkedin.com/in/jhonatan-cardona-6199a4162/" target="_black"><i
